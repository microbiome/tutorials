...
```{r stability2, message=FALSE, warning=FALSE, eval=FALSE, fig.width=12, fig.height=5, out.width="500px"}
...
```{r stability-tipping, message=FALSE, warning=FALSE, eval=FALSE}
...
```{r stability-variationplot, eval=FALSE, message=FALSE, warning=FALSE, fig.show='hold', out.width="430px"}
