...
```{r coreC, fig.width=9, fig.heigth=6, out.width="400px", warning=FALSE, eval=TRUE}
# With compositional (relative) abundances
det <- c(0, 0.1, 0.5, 2, 5, 20)/100
prevalences <- seq(.05, 1, .05)
plot_core(pseq.rel, prevalences = prevalences, detections = det, plot.type = "lineplot") + xlab("Relative Abundance (%)")
...
```{r core-exampleD-a, fig.width=9, fig.heigth=6, out.width="400px", warning=FALSE,message=FALSE}
# Core with compositionals:
prevalences <- seq(.05, 1, .05)
...
```{r core-exampleD-b, fig.width=9, fig.heigth=6, out.width="400px",warning=FALSE,message=FALSE}
