...
```{r core2_plot, fig.width=9, fig.heigth=6, out.width="400px", warning=FALSE, eval=FALSE}
...
p1 <- plot_core(pseq.rel, plot.type = "heatmap", colours = gray,
...
```{r core-example3_plot, fig.width=8, fig.heigth=18, fig.show='hold', out.width = '200px', warning=FALSE, eval=FALSE}
print(p1)
library(viridis)
