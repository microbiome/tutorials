...
```{r DMM0, fig.width=6, fig.height=5, warning=FALSE, message=FALSE, eval=FALSE}
library(microbiome)
...
```{r DMM, fig.width=6, fig.height=5, warning=FALSE, message=FALSE, eval=FALSE}
...
```{r DMMplot, fig.width=6, fig.height=5, warning=FALSE, message=FALSE, eval=FALSE}
...
```{r DMM3, fig.width=6, fig.height=5, warning=FALSE, message=FALSE, eval=FALSE}
best <- fit[[which.min(lplc)]]
```

Mixture parameters pi and theta

```{r DMM4, fig.width=6, fig.height=5, warning=FALSE, message=FALSE, eval=FALSE}
mixturewt(best)
```

Sample-component assignments

```{r DMM5, fig.width=6, fig.height=5, warning=FALSE, message=FALSE, eval=FALSE} 
ass <- apply(mixture(best), 1, which.max)
```

Contribution of each taxonomic group to each component

```{r DMM6, fig.width=6, fig.height=5, warning=FALSE, message=FALSE, fig.show="hold", out.width="33%", eval=FALSE}
