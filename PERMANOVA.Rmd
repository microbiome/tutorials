...
```{r comparisons_permanova_visu, fig.width=10, fig.height=6,error=FALSE, message=FALSE, warnings=FALSE, out.width="300px"}
...
```{r permanova_top, fig.width=5, fig.height=5, message=FALSE, error=FALSE, warnings=FALSE, out.width="300px"}
