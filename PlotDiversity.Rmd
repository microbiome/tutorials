...
```{r Ad-plot6, echo=F, warning=FALSE, message=FALSE, fig.width=8, fig.height=6, eval=FALSE}
print(p1)
```
...
```{r Ad-plot6a, warning=FALSE, message=FALSE, eval=FALSE}
p1 <- p1 + stat_compare_means(comparisons = bmi.pairs)
```


```{r Ad-plot7,echo=F ,warning=FALSE, message=FALSE, eval=FALSE}
print(p1)
```
